...
private void StokKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StokKeyPressed
    ...
    */
    ...
    public void isCek(){
        ...
        BtnHapus.setEnabled(akses.getpegawai_user()); //edit-novan hapus dari user pegawai
        BtnPrint.setEnabled(akses.getpegawai_user()); //edit-novan print dari user pegawai
    }
}
