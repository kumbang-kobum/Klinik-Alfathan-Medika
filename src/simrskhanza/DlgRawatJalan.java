...
import rekammedis.RMHasilRadiologi;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    public  DlgCariSoap soap=new DlgCariSoap(null,false);
    private RMCariHasilLaborat carilaborat=new RMCariHasilLaborat(null,false); //edit-novan
    ...
    private void initComponents() {
        ...
        jLabel17.setBounds(600, 250, 100, 23);

        jLabel9.setText("Objek :");
        jLabel9.setName("jLabel9"); // NOI18N
        panelGlass12.add(jLabel9);
        jLabel9.setBounds(0, 215, 70, 23);
        ...
        jLabel20.setBounds(600, 280, 100, 23);

        jLabel22.setText("GCS (E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(590, 310, 70, 23);

        scrollPane1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane1.setName("scrollPane1"); // NOI18N
        scrollPane1.setPreferredSize(new java.awt.Dimension(174, 74));
        ...
        TKeluhan.setPreferredSize(new java.awt.Dimension(182, 500));
        ...
        scrollPane1.setBounds(73, 70, 360, 140);
        ...
        TPemeriksaan.setPreferredSize(new java.awt.Dimension(182, 500));
        ...
        scrollPane2.setBounds(73, 215, 360, 130);
        ...
        TTensi.setBounds(540, 280, 55, 23);
        ...
        TTinggi.setBounds(710, 250, 55, 23);
        ...
        TRespirasi.setBounds(710, 280, 55, 23);
        ...
        TBerat.setBounds(850, 250, 55, 23);
        ...
        jLabel29.setBounds(700, 310, 70, 23);
        ...
        cmbKesadaran.setBounds(780, 310, 126, 23);
        ...
        jLabel54.setBounds(470, 310, 70, 23);
        ...
        BtnRiwayat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        BtnRiwayat1.setText("Intip USG/Radiologi");
        BtnRiwayat1.setFocusPainted(false);
        BtnRiwayat1.setGlassColor(new java.awt.Color(0, 153, 51));
        BtnRiwayat1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayat1.setIconTextGap(8);
        ...
        panelGlass12.add(BtnRiwayat1);
        BtnRiwayat1.setBounds(930, 20, 160, 23);

        BtnRiwayat2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Syringe.png"))); // NOI18N
        BtnRiwayat2.setText("Intip Laboratorium");
        BtnRiwayat2.setFocusPainted(false);
        BtnRiwayat2.setGlassColor(new java.awt.Color(0, 153, 51));
        BtnRiwayat2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayat2.setIconTextGap(8);
        BtnRiwayat2.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayat2.setName("BtnRiwayat2"); // NOI18N
        BtnRiwayat2.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnRiwayat2.setRoundRect(false);
        BtnRiwayat2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayat2ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRiwayat2);
        BtnRiwayat2.setBounds(930, 50, 160, 23);
        ...
        BtnCari1.setBounds(930, 90, 170, 20);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane5.setName("scrollPane5"); // NOI18N
        scrollPane5.setPreferredSize(new java.awt.Dimension(250, 74));

        TPlan.setEditable(false);
        TPlan.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TPlan.setColumns(20);
        TPlan.setRows(5);
        TPlan.setName("TPlan"); // NOI18N
        TPlan.setPreferredSize(new java.awt.Dimension(182, 500));
        TPlan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TPlanKeyPressed(evt);
            }
        });
        scrollPane5.setViewportView(TPlan);

        panelGlass12.add(scrollPane5);
        scrollPane5.setBounds(930, 150, 200, 90);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Catatan Pasien");
        jLabel58.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass12.add(jLabel58);
        jLabel58.setBounds(930, 130, 110, 23);
        ...
        BtnCari2.setBounds(930, 110, 190, 20);

        BtnBukaTemplateSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/PatientFile.png"))); // NOI18N
        BtnBukaTemplateSoap.setMnemonic('B');
        BtnBukaTemplateSoap.setText("Buka Template SOAP");
        BtnBukaTemplateSoap.setToolTipText("Alt+B");
        BtnBukaTemplateSoap.setName("BtnBukaTemplateSoap"); // NOI18N
        BtnBukaTemplateSoap.setPreferredSize(new java.awt.Dimension(170, 30));
        ...
        BtnBukaTemplateSoap.setBounds(930, 300, 180, 30);

        BtnSimpanSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        BtnSimpanSoap.setMnemonic('S');
        BtnSimpanSoap.setText("Simpan Template SOAP");
        BtnSimpanSoap.setToolTipText("Alt+S");
        BtnSimpanSoap.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        BtnSimpanSoap.setName("BtnSimpanSoap"); // NOI18N
        BtnSimpanSoap.setPreferredSize(new java.awt.Dimension(170, 30));
        ...
        BtnSimpanSoap.setBounds(930, 270, 180, 30);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-10-2023" }));
                    ...
                    if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||(!TSuhu.getText().trim().equals(""))||
                        ...
                        if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                ...
                                Sequel.menyimpan("mutasi_berkas","'"+TNoRw.getText()+"','Sudah Periksa',now(),now(),NOW() + INTERVAL 1 MINUTE,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'","status='Sudah Periksa',sudah=NOW() + INTERVAL 1 MINUTE","no_rawat='"+TNoRw.getText()+"'"); //edit-novan kebutuhan mjkn ketika simpan soap = sudah pelayanan poli
                                }else{
    ...
    private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRawatMouseClicked
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 3:
                ...
                TCari.setText(TNoRw.getText()); //edit-novan pencarian berdasarkan no rawat
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                if(jmlparsial>0){
                    ...
                    if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                        ...
                        Sequel.mengedit("reg_periksa","no_rawat=?","stts=?",2,new String[]{"Sudah",TNoRw.getText()}); //edit-novan kebutuhan task id mjkn status menjadi sudah ketika simpan resep dokter
                        inputResep();
                    }
                }                     
            }            
    ...
    private void BtnRiwayatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            resume.setNoRm(TNoRM.getText(),TPasien.getText(),TNoRw.getText()); //edit-novan auto no rawat di riwayat perawatan
    ...
    private void BtnRiwayat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayat1ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            RMHasilRadiologi hasilradiologi=new RMHasilRadiologi(null,true);
            hasilradiologi.setNoRm(TNoRM.getText(),TPasien.getText(),TNoRw.getText());
            hasilradiologi.tampilPerawatan();
            hasilradiologi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            hasilradiologi.setLocationRelativeTo(internalFrame1);
            hasilradiologi.setVisible(true);

        }
    }//GEN-LAST:event_BtnRiwayat1ActionPerformed

    private void BtnRiwayat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayat2ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Pasien masih kosong...!!!");
        }else{
    ...
    }//GEN-LAST:event_BtnRiwayat2ActionPerformed
    ...
    private void TPlanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TPlanKeyPressed

    }//GEN-LAST:event_TPlanKeyPressed
    ...
    private void BtnSimpanSoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanSoapActionPerformed
        if(TKeluhan.getText().trim().equals("")){
            ...
            Sequel.menyimpan("template_soap","'0','"+TKeluhan.getText()+"','"+TPemeriksaan.getText()+"','"+TPenilaian.getText()+"','"+TindakLanjut.getText()+"'","Template Soap");
    ...
    */
    ...
    private widget.Button BtnRiwayat2;
    ...
    private void isPsien(){
        ...
        if(Sequel.cariInteger("select count(no_rkm_medis) from catatan_pasien where no_rkm_medis='"+TNoRM.getText()+"' ")>0){
            TPlan.setText(Sequel.cariIsi("select catatan from catatan_pasien where no_rkm_medis="+TNoRM.getText()));}
    }
    ...
    public void isCek(){
        tinggi=0;
        BtnSeekPegawai.setEnabled(akses.getadmin()); //edit-novan Disable ubah petugas, harus sesuai yg login
        BtnSeekPetugas.setEnabled(akses.getadmin()); //edit-novan Disable ubah petugas, harus sesuai yg login
        BtnSeekPetugas2.setEnabled(akses.getadmin()); //edit-novan Disable ubah petugas, harus sesuai yg login
        BtnSimpan.setEnabled(akses.gettindakan_ralan());
        BtnHapus.setEnabled(akses.gettindakan_ralan());
        BtnEdit.setEnabled(akses.gettindakan_ralan());
        BtnPrint.setEnabled(akses.gettindakan_ralan());
        ...
        if(akses.getjml2()>=1){
            ...
            kdptg.setText(akses.getkode()); //edit-novan petugas sesuai yg login
            kdptg2.setText(akses.getkode()); //edit-novan petugas sesuai yg login
            TPegawai.setText(pegawai.tampil3(KdPeg.getText()));
            TPerawat.setText(pegawai.tampil3(kdptg.getText())); //edit-novan petugas sesuai yg login
            TPerawat2.setText(pegawai.tampil3(kdptg2.getText())); //edit-novan petugas sesuai yg login
            Jabatan.setText(pegawai.tampilJbatan(KdPeg.getText()));
        }
        ChkJln.setEnabled(akses.getpegawai_user()); //edit-novan pembatasan ceklis jam menggunakan hak akses pegawai user
    }
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "inner join pemeriksaan_ralan on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "+
                    "inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik where  "+
                    "pemeriksaan_ralan.tgl_perawatan between ? and ? and reg_periksa.no_rkm_medis like ? and pemeriksaan_ralan.no_rawat like ? "+ //edit-novan and pemeriksaan_ralan.no_rawat like ?
            ...
            try{
                ...
                ps4.setString(4,"%"+TNoRw.getText().trim()+"%"); //edit-novan pencarian berdasarkan no rawat
                if(!TCari.getText().trim().equals("")){
                    ...
                    ps4.setString(12,"%"+TCari.getText().trim()+"%"); //edit-novan pencarian berdasarkan no rawat
                }
                rs=ps4.executeQuery();
                while(rs.next()){
                    tabModePemeriksaan.addRow(new Object[]{
