...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private RMCariHasilLaborat carilaborat=new RMCariHasilLaborat(null,false);//edit-novan Intip laborat
    ...
    private void initComponents() {
        ...
        BtnRiwayat1.setLabel("Intip Radiologi");
        ...
        BtnRiwayat1.setBounds(930, 40, 160, 23);
        ...
        BtnRiwayat2.setBounds(930, 90, 160, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2023" }));
        ...
        BtnPeriksaRad.setText("Periksa Radiologi");
        ...
        BtnPeriksaRad.setPreferredSize(new java.awt.Dimension(190, 23));
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnPeriksaRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPeriksaRadActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>9){
