...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2023" }));
        ...
        if(tabMode.getRowCount()!=0){
            ...
            if(evt.getClickCount()==2){
                ...
                if(i==0){
                    ...
                    if(akses.getkamar_inap()==true){ //edit-novan Lihat billing di ranap
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void ppRiwayatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayatBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            resume.setNoRm(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),1).toString(),tbKamIn.getValueAt(tbKamIn.getSelectedRow(),2).toString(),tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString()); //edit-novan auto no rawat di riwayat perawatan
    ...
    */
    ...
    public void isCek(){
        try {
            ...
            btnPindah.setEnabled(akses.getregistrasi()); //edit-novan pindah kamar hanya bagian registrasi
            BtnIn.setEnabled(akses.getadmin()); //edit-novan pembatasan hak akses pindah kamar
            Rganti1.setEnabled(akses.getadmin()); //edit-novan pembatasan hak akses pindah kamar
            Rganti2.setEnabled(akses.getadmin()); //edit-novan pembatasan hak akses pindah kamar
            Rganti4.setEnabled(akses.getadmin()); //edit-novan pembatasan hak akses pindah kamar
        } catch (Exception ex) {
            namakamar="";
        }
        ...
        MnPenjab.setEnabled(akses.getregistrasi()); //edit-novan ganti jenis bayar hanya dari registrasi
