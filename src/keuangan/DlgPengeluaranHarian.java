                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            sukses=jur.simpanJurnal(Nomor.getText(),"U","PENGELUARAN"+Keterangan.getText()+", OLEH "+akses.getkode()); //edit-novan
                        } 
                    } catch (Exception e) {
                        sukses=false;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                sukses=jur.simpanJurnal(Nomor.getText(),"U","PEMBATALAN PENGELUARAN"+Keterangan.getText()+", OLEH "+akses.getkode()); //edit-novan
                            } 
                        } catch (Exception e) {
                            sukses=false;
                            System.out.println("Notif : "+e);
