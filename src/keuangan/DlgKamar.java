...
private void CmbCrIsiItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbCrIsiItemStateChanged
    ...
    */
    ...
    public JTable getTable(){
     ...
     public void isCek(){
        BtnBatal.setEnabled(akses.getadmin()); //edit-novan tombol baru dari akun admin
        BtnSimpan.setEnabled(akses.getadmin()); //edit-novan simpan kamar hanya admin
        BtnHapus.setEnabled(akses.getadmin()); //edit-novan hapus kamar hanya admin
        BtnPrint.setEnabled(akses.getkamar());
        btnKamar.setEnabled(akses.getadmin()); //edit-novan klip kamar hanya admin
        TKd.setEditable(akses.getadmin()); //edit-novan no bed hanya admin
        TTarif.setEditable(akses.getadmin()); //edit-novan Tarif kamar hanya admin
        kd_bangsal.setEditable(akses.getadmin()); //edit-novan kode kamar hanya admin
        Kelas.setEnabled(akses.getadmin()); //edit-novan Ubah Kelas hanya admin
        asalform=akses.getform();
        if(akses.getkode().equals("Admin Utama")){
            MnRestore.setEnabled(true);
            BtnEdit.setEnabled(true);
        }else{
            if(akses.getregistrasi()==false){ //edit-novan ubah status dari resepsionis
