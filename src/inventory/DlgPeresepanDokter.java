...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(440, 155));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-10-2023" }));
        ...
        scrollPane3.setPreferredSize(new java.awt.Dimension(250, 74));
        ...
        scrollPane3.setViewportView(TPlan);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(710, 10, 360, 140);
    ...
    */
    ...
    public void tampilobat() {        
        if(Sequel.cariInteger("select count(no_rawat) from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' ")>0){
            TPlan.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"' and nip='"+KdDokter.getText()+"'"));
        }//edit-novan (u/ contekan resep dokter dari soap ralan)
        z=0;
        for(i=0;i<tbResep.getRowCount();i++){
