    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "group by reg_periksa.no_rawat order by periksa_lab.tgl_periksa,reg_periksa.jam_reg"); //edit-novan ,periksa_lab.tgl_periksa,periksa_lab.jam (grouping berdasarkan no rawat)
            try {
