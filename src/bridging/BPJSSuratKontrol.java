...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    public BPJSSuratKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "No.Surat","Tgl.Kontrol","Kode Dokter","Nama Dokter/Sepesialis","Kode Poli","Nama Poli/Unit","Catatan" //edit-novan penambahan catatan
            }){
    ...
    private void initComponents() {
        ...
        Catatan.setBounds(790, 100, 220, 24);

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel18.setText("Catatan :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(792, 77, 60, 23);
        ...
        if(NoRawat.getText().trim().equals("")||NoSEP.getText().trim().equals("")){
            ...
            try {
                ...
                if(nameNode.path("code").asText().equals("200")){
                    ...
                    if(Sequel.menyimpantf("bridging_surat_kontrol_bpjs","?,?,?,?,?,?,?,?","No.Surat",9,new String[]{ //edit-novan penambahan catatan
                            NoSEP.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),response.asText(),Valid.SetTgl(TanggalKontrol.getSelectedItem()+""),KdDokter.getText(),NmDokter.getText(),KdPoli.getText(),NmPoli.getText(),Catatan.getText() //edit-novan penambahan catatan
                        })==true){
                        emptTeks();
                        tampil();
  ...
  isForm();                
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            ...
            Valid.MyReportqry("rptBridgingSuratKontrol2.jasper","report","::[ Data Surat Kontrol VClaim ]::",
                    ...
                    "bridging_sep.jkel,bridging_sep.diagawal,bridging_sep.nmdiagnosaawal,bridging_surat_kontrol_bpjs.tgl_surat,bridging_surat_kontrol_bpjs.no_surat,"+
                    "bridging_surat_kontrol_bpjs.tgl_rencana,bridging_surat_kontrol_bpjs.kd_dokter_bpjs,bridging_surat_kontrol_bpjs.nm_dokter_bpjs,"+
                    "bridging_surat_kontrol_bpjs.kd_poli_bpjs,bridging_surat_kontrol_bpjs.nm_poli_bpjs,bridging_surat_kontrol_bpjs.catatan from bridging_sep inner join bridging_surat_kontrol_bpjs "+ //edit-novan penambahan catatan
    ...
    */
                ...
                try {
                    ...
                    while(rs.next()){
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("tgl_rencana"),rs.getString("kd_dokter_bpjs"),rs.getString("nm_dokter_bpjs"),rs.getString("kd_poli_bpjs"),rs.getString("nm_poli_bpjs"),rs.getString("catatan") //edit-novan penambahan catatan
                        });                    
                    }
                } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        KdPoli.setText("");
        NmPoli.setText("");
        Catatan.setText("-"); //edit-novan penambahan catatan
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Catatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString()); //edit-novan penambahan catatan
